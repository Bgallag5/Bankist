      ...
      <div className="slider">
        ...
        <div className="slide slide--2">
          <div className="testimonial">
            ...
            <address className="testimonial__author">
              <img src={require("../img/user-2.jpg")} alt="" className="testimonial__photo" />
        ...
        <div className="slide slide--3">
          <div className="testimonial">
            ...
            <address className="testimonial__author">
              <img src={require("../img/user-3.jpg")} alt="" className="testimonial__photo" />
        ...
        <button data-direction="left" className="slider__btn slider__btn--left">&larr;</button>
        <button data-direction="right" className="slider__btn slider__btn--right">&rarr;</button>
